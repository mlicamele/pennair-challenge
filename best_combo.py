...
def image_brightness(file_name, show_steps=False):
...
def image_3D_brightness(file_name, show_steps=False):
...
def video_brightness(file_name, show_steps=False):
...
def video_3D_brightness(file_name, show_steps=False):
...
func_names = [image_brightness, image_3D_brightness, video_brightness, video_3D_brightness, video_agnostic_consistency, video_3D_agnostic_consistency]
